...
class ContactForm(forms.Form):
    FirstName = forms.CharField(max_length = 30, required=True, help_text='optional')
    LastName = forms.CharField(max_length = 30, required=True, help_text='optional')
...
class ApplicationForm(forms.Form):
    FirstName = forms.CharField(max_length = 30, required=True, help_text='optional')
    MiddleName = forms.CharField(max_length = 30, required=True, help_text='optional')
    LastName = forms.CharField(max_length = 30, required=True, help_text='optional')
    email = forms.EmailField(max_length=100, required=True, help_text='required')
