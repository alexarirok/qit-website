...
class AuthorSubscriber(models.Model):
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='author_author')
...
#                                    default="You can contact us in mail. Our mail you can see in down")
#     USERNAME_FIELD = 'user'
